...
public class ViewMusicModifyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private MusicService musicService;

	public ViewMusicModifyServlet() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (userVO.getAuthorizationId().equals(AuthConst.NORMAL_USER)) {
			...
			MusicVO musicVO = musicService.getOneMusicforUpdate(musicId);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (userVO.getAuthorizationId().equals(AuthConst.NORMAL_USER)) {
			...
			boolean isSuccess = musicService.updateOneMusic(musicVO);
